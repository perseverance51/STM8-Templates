...
// GSIK patch: allow user configurable configuration via config.h
#include "config.h"

#if !defined(_USE_READ)  // GSIK patch
  #define	_USE_READ	0	/* Enable pf_read() function */
#endif
#if !defined(_USE_DIR)  // GSIK patch
  #define	_USE_DIR	0	/* Enable pf_opendir() and pf_readdir() function */
#endif
#if !defined(_USE_LSEEK)  // GSIK patch
  #define	_USE_LSEEK	0	/* Enable pf_lseek() function */
#endif
#if !defined(_USE_WRITE)  // GSIK patch
  #define	_USE_WRITE	0	/* Enable pf_write() function */
#endif

#if !defined(_FS_FAT12)  // GSIK patch
  #define _FS_FAT12	0	/* Enable FAT12 */
#endif
#if !defined(_FS_FAT16)  // GSIK patch
  #define _FS_FAT16	1	/* Enable FAT16 */
#endif
#if !defined(_FS_FAT32)  // GSIK patch
...
#if !defined(_USE_LCC)  // GSIK patch
  #define _USE_LCC	0	/* Allow lower case characters for path name */
#endif

#if !defined(_CODE_PAGE)  // GSIK patch
...
// GSIK comment: STM8 is big-endian -> don't make _WORD_ACCESS user-configurable
